...
На входе она принимет кусок изображения. 
Далее путем корреляции (либо путем сопостовления гистограм, либо взятия хэша изображения) она на ходит скриншоте текущего экрана этот фрагмент и кликает в центр этого участка.
...
# Утилита выбора прямоугольного участка для клика usefulcliker_gui
	...
	## Обрезка изображения по выбранному прямоугольнику
...
Ты должен реализовать достаточный функционал чтобы можно было на xml-языке кликера написать программу youtube_keywords.
На входе у youtube_keywords должен быть текстовый промт или тематика.
